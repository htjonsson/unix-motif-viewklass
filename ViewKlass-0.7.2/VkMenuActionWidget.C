...
#endif
	= "$Id: VkMenuActionWidget.C,v 1.5 2009/03/21 11:44:34 jostle Exp $";
...
void
VkMenuActionWidget::build(Widget parent)
{
	Arg args[4];
	int n = 0;
	...
	_baseWidget = XmCreatePushButton(parent, (char*)name(), args, n);
