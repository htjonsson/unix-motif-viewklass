...
IGrid::IGrid(const char* name, Widget parent)
:   VkComponent(name)
{
...
Widget
IGrid::createContainer(Widget parent)
{
...
Widget
IGrid::createNode(Widget parent, const char* text, Widget parentNode)
{
    Widget widget;
...
Widget
IGrid::createRootNode(Widget parent, const char* text, bool expaned)
{
    Widget widget;
...
void 
IGrid::selectionCallback(Widget widget, XtPointer userdata, XmContainerSelectCallbackStruct* calldata)
{
...
void 
IGrid::outlineChangedCallback(Widget widget, XtPointer userdata, XmContainerOutlineCallbackStruct* calldata)
{
